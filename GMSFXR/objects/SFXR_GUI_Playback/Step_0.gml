if (imguigml_ready()) {
    ...
    imguigml_begin("Playback",undefined,EImGui_WindowFlags.NoTitleBar|EImGui_WindowFlags.NoMove|EImGui_WindowFlags.NoResize|EImGui_WindowFlags.NoCollapse);
    
        imguigml_push_item_width(sprite_width*0.58);
