...
if(irandom(1)) {
	sfxr_set_freq_start(0.2 + sfxr_util_frnd(0.3));
	sfxr_set_freq_slide(0.1 + sfxr_util_frnd(0.4));
	sfxr_set_repeat_speed(0.4 + sfxr_util_frnd(0.4));
} else {
	sfxr_set_freq_start(0.2 + sfxr_util_frnd(0.3));
	sfxr_set_freq_slide(0.05 + sfxr_util_frnd(0.2));
	if(irandom(1)) {
...
sfxr_set_env_sustain_time(sfxr_util_frnd(0.4));
